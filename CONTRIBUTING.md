Code contributions must be submitted using [GitHub Pull Requests](https://github.com/EraseMC/PocketMine-MP/pulls), where they will be reviewed by EraseMC maintainers.
...
> [!TIP]
> Translation workflow will be documented when the EraseMC localization service is enabled.
...
|:----------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [EraseMC/BedrockProtocol](https://github.com/EraseMC/BedrockProtocol) | `pocketmine\network\mcpe\protocol`                                                                                                       |
...
1. [Fork the repository on GitHub](https://github.com/EraseMC/PocketMine-MP/fork). This gives you your own copy of the repository to make changes to.
2. Create a branch on your fork for your changes.
3. Make the changes you want to make on this branch.
4. You can then make a [pull request](https://github.com/EraseMC/PocketMine-MP/pull/new) to the project.
...
>
> Mistakes are normal, and EraseMC maintainers will review your code and suggest changes as needed.
...
- **Start small.**
  ...
  - Check out the [open issues](https://github.com/EraseMC/PocketMine-MP/issues) for things you could work on to familiarise yourself with the codebase.
