...
final class BlockTranslator{
	...
	private const PATHS = [
		...
		ProtocolInfo::PROTOCOL_1_19_80 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.80', self::BLOCK_STATE_META_MAP_PATH => '-1.19.80'],
		ProtocolInfo::PROTOCOL_1_19_70 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.70', self::BLOCK_STATE_META_MAP_PATH => '-1.19.70'],
		ProtocolInfo::PROTOCOL_1_19_63 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.63', self::BLOCK_STATE_META_MAP_PATH => '-1.19.63'],
		ProtocolInfo::PROTOCOL_1_19_60 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.63', self::BLOCK_STATE_META_MAP_PATH => '-1.19.63'],
		ProtocolInfo::PROTOCOL_1_19_50 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.50', self::BLOCK_STATE_META_MAP_PATH => '-1.19.50'],
		ProtocolInfo::PROTOCOL_1_19_40 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.40', self::BLOCK_STATE_META_MAP_PATH => '-1.19.40'],
		ProtocolInfo::PROTOCOL_1_19_30 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.40', self::BLOCK_STATE_META_MAP_PATH => '-1.19.40'],
		ProtocolInfo::PROTOCOL_1_19_21 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.40', self::BLOCK_STATE_META_MAP_PATH => '-1.19.40'],
		ProtocolInfo::PROTOCOL_1_19_20 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.40', self::BLOCK_STATE_META_MAP_PATH => '-1.19.40'],
		ProtocolInfo::PROTOCOL_1_19_10 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.10', self::BLOCK_STATE_META_MAP_PATH => '-1.19.10'],
		ProtocolInfo::PROTOCOL_1_19_0 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.19.10', self::BLOCK_STATE_META_MAP_PATH => '-1.19.10'],
		ProtocolInfo::PROTOCOL_1_18_30 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.18.30', self::BLOCK_STATE_META_MAP_PATH => '-1.18.30'],
		ProtocolInfo::PROTOCOL_1_18_10 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.18.10', self::BLOCK_STATE_META_MAP_PATH => '-1.18.10'],
		ProtocolInfo::PROTOCOL_1_18_0 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.18.0', self::BLOCK_STATE_META_MAP_PATH => '-1.18.0'],
		ProtocolInfo::PROTOCOL_1_17_40 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.17.40', self::BLOCK_STATE_META_MAP_PATH => '-1.17.40'],
		ProtocolInfo::PROTOCOL_1_17_30 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.17.30', self::BLOCK_STATE_META_MAP_PATH => '-1.17.30'],
		ProtocolInfo::PROTOCOL_1_17_10 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.17.10', self::BLOCK_STATE_META_MAP_PATH => '-1.17.10'],
		ProtocolInfo::PROTOCOL_1_17_0 => [self::CANONICAL_BLOCK_STATES_PATH => '-1.17.0', self::BLOCK_STATE_META_MAP_PATH => '-1.17.0'],
